        ...
        <div className="bg-[#fff] flex flex-col w-[440px] rounded-xl ">
          ...
          <div className="w-full bg-[#F7F8FA] rounded-b-lg h-auto px-4">
            ...
            <div class="relative w-full mb-5">
              <input class="border w-full border-gray-200 leading-5 py-3 pl-4 pr-10" type="text" placeholder="YYYY/MM/DD" />
              <svg class="absolute top-1/2 transform -translate-y-1/2 right-4 text-gray-500" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
